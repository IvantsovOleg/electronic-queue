                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.talonWithStatusShow.length; i++) {
                        if(data.talonWithStatusShow[i].IS_NEED_VOICE==1){
                            activeString += '<div class="oneActiveRoom"><div class="infoAboutTalon infoAboutRoom blink2"  ><b class="activeTalon">' + data.talonWithStatusShow[i].CODE + '</b><b class="activeRoom"> - ' + data.talonWithStatusShow[i].ROOM + '</b></div> <div class="infoAboutRoom"></div></div>';
                        }else{
                ...
                success: function (data) {
                    for (var selector in data.data) {
                        if (data.data[selector]['room']) {
                            ...
                            if (underScore.isNull(videoFlag)) {
                                stringToRender += '<div class="row" id="' + data.data[selector]['room'] + '"><div class="rooms head">' + data.data[selector]['room'] + '&nbsp;&nbsp;</div><div class="stringactive head blink2">' + activeTalon +
                                '</div><div class="stringpas pull-right head rightCol">' + waitingTalon + '&nbsp;&nbsp;</div> </div>';
