                ...
                success: function (data) {
                    ...
                    if (underScore.isNull(videoFlag)) {
                     ...
                     if (data.lengthQueueList !== null) {
						document.getElementById('bottomPart').innerHTML = '<p class="queue_count" style="text-align: center; font-size: 3em;">' +
								'В очереди ' + data.lengthQueueList + ' ' + getUnitsText(data.lengthQueueList, ['номерок', 'номерка','номерков']) + '</p>' ;
